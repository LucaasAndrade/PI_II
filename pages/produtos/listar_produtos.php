            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a id="deleteButton" href="#" class="btn btn-danger">Excluir</a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Esse é o script do modal -->
    ...
    $(document).ready(function() {
        ...
        // Manipulador de eventos para o botão de exclusão dentro do modal
        $('#deleteButton').click(function() {
            var url = $(this).attr('href');
            window.location.href = url; // Redirecionar para a URL de exclusão
        });
    });
</script>
