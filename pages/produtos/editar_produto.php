    ...
    <section class="form__container container mt-5">
        ...
        <form action="../../utils/adm/editarProd.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nome" id="nome" class="form-control" value="<?php echo $produto['PRODUTO_NOME']; ?>" required>
            </div>
            <div class="mb-3">
                <label for="descricao" class="form-label">Descrição</label>
                <textarea name="descricao" cols="30" rows="10" class="form-control" required><?php echo $produto['PRODUTO_DESC']; ?></textarea>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="checkbox" name="ativo" value="1" <?php echo $produto['PRODUTO_ATIVO'] == 1 ? 'checked' : '' ?>>
                </div>
